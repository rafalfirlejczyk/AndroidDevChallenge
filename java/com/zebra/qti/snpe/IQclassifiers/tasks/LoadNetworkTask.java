 ...
 */
package com.zebra.qti.snpe.IQclassifiers.tasks;
...
import com.zebra.qti.snpe.IQclassifiers.Model;
import com.zebra.qti.snpe.IQclassifiers.ModelOverviewFragmentController;
...
public class LoadNetworkTask extends AsyncTask<File, Void, NeuralNetwork> {
    ...
    private final ModelOverviewFragmentController.SupportedTensorFormat mTensorFormat;
    ...
    public LoadNetworkTask(final Application application,
                           ...
                           final ModelOverviewFragmentController.SupportedTensorFormat tensorFormat) {
    ...
    protected NeuralNetwork doInBackground(File... params) {
        ...
        try {
            final SNPE.NeuralNetworkBuilder builder = new SNPE.NeuralNetworkBuilder(mApplication)
                    ...
                    .setUseUserSuppliedBuffers(mTensorFormat != ModelOverviewFragmentController.SupportedTensorFormat.FLOAT);
